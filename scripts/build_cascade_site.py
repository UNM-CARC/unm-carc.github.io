...
html[data-theme="dark"] #nav ul.carc-sections li.carc-dropdown .dropdown-menu { background-color: #10131a !important; border-color: #27313c !important; }
@media (prefers-color-scheme: dark) { html:not([data-theme="light"]) #nav ul.carc-sections li.carc-dropdown .dropdown-menu { background-color: #10131a !important; border-color: #27313c !important; } }
